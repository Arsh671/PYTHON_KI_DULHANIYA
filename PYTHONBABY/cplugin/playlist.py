...
from PYTHONBABY.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from PYTHONBABY import Carbon, app
from PYTHONBABY.utils.decorators.language import language, languageCB
from PYTHONBABY.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from PYTHONBABY.core.mongo import mongodb
...
async def add_playlist_clone(client: Client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from PYTHONBABY import YouTube
...
@Client.on_callback_query(filters.regex("Brandrd_playlist") & ~BANNED_USERS)
@languageCB
